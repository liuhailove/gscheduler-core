 ...
 */
public class ExecutorRouteMinLoad extends ExecutorRouter {
    ...
    public ReturnT<String> route(TriggerParam triggerParam, List<String> addressList) {
        JobRegistry registry = JobAdminConfig.getAdminConfig().getJobRegistryDao().findMinLoadAddress(triggerParam.getAppname());
